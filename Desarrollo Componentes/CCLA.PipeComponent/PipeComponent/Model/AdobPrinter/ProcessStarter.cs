...
namespace PipeComponent.Model.AdobPrinter
{
    class ProcessStarter : IDisposable
    {
        ...
        /// </summary>
        /// <returns></returns>
        public int WaitForExit(uint tiempo)
        {
            WaitForSingleObject(processInfo_.hProcess, tiempo > 0? tiempo : INFINITE);
